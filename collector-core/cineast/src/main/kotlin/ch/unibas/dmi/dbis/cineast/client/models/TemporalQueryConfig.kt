...
data class TemporalQueryConfig (

    @field:JsonProperty("queryId")
    val queryId: kotlin.String? = null,

    @field:JsonProperty("hints")
    val hints: kotlin.collections.Set<TemporalQueryConfig.Hints>? = null,

    @field:JsonProperty("timeDistances")
    val timeDistances: kotlin.collections.List<kotlin.Float>? = null,

    @field:JsonProperty("maxLength")
    val maxLength: kotlin.Float? = null,

    @field:JsonProperty("computeTemporalObjects")
    val computeTemporalObjects: kotlin.Boolean? = null,
    ...
    val distance: TemporalQueryConfig.Distance? = null,
